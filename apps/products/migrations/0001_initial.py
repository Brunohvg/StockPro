    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=50, verbose_name="Nome do Atributo"),
                ),
                (
                    "tenant",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sku",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="SKU Base"
                    ),
                ),
                (
                    "name",
                ...
                (
                    "uom",
                    models.CharField(
                        default="UN", max_length=10, verbose_name="Unidade"
                    ),
                ),
                (
                    "barcode",
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Usado para calcular margem bruta.",
                        max_digits=12,
                        null=True,
                ...
                (
                    "requires_review",
                    models.BooleanField(default=False, verbose_name="Requer Revisão"),
                ),
                (
                    "ai_confidence",
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Nome da Variação"
                    ),
                ),
                (
                    "barcode",
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Sobrepõe o preço do produto pai.",
                        max_digits=12,
                        null=True,
                        verbose_name="Preço de Venda",
                    ),
